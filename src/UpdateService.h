...
class UpdateServiceIf {
 public:
  ...
  virtual void update(const std::string& img_, const Pose& odom_data) = 0;
};
...
typedef struct _UpdateService_update_args__isset {
  _UpdateService_update_args__isset() : img_(false), odom_data(false) {}
  bool img_ :1;
  bool odom_data :1;
...
class UpdateService_update_args {
 public:
  ...
  void __set_odom_data(const Pose& val);

  bool operator == (const UpdateService_update_args & rhs) const
  {
    if (!(img_ == rhs.img_))
      return false;
    if (!(odom_data == rhs.odom_data))
      return false;
    return true;
  }
  bool operator != (const UpdateService_update_args &rhs) const {
...
class UpdateServiceClient : virtual public UpdateServiceIf {
 ...
 public:
  ...
  void update(const std::string& img_, const Pose& odom_data);
  void send_update(const std::string& img_, const Pose& odom_data);
  void recv_update();
 protected:
...
class UpdateServiceMultiface : virtual public UpdateServiceIf {
 ...
 public:
  void update(const std::string& img_, const Pose& odom_data) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->update(img_, odom_data);
    }
    ifaces_[i]->update(img_, odom_data);
  }
...
class UpdateServiceConcurrentClient : virtual public UpdateServiceIf {
 ...
 public:
  ...
  void update(const std::string& img_, const Pose& odom_data);
  int32_t send_update(const std::string& img_, const Pose& odom_data);
